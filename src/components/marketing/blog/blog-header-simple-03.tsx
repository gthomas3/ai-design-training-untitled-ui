            ...
            <section className="bg-brand-section pt-32 pb-32 md:pt-24 md:pb-40">
                <div className="mx-auto max-w-container px-4 md:px-8">
                    <div className="mx-auto flex w-full max-w-3xl flex-col items-center text-center">
                        <span className="text-sm font-semibold text-secondary_on-brand md:text-md">Our blog</span>
                        <h2 className="mt-3 text-display-md font-semibold text-primary_on-brand md:text-display-lg">Stories and interviews</h2>
