            ...
            <div className="mx-auto max-w-container md:px-8">
                ...
                <div className="mx-auto mt-12 grid max-w-xl grid-cols-1 items-start gap-12 md:mt-16 md:gap-16 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                    <ul className="grid w-full grid-cols-1 gap-x-8 gap-y-10 px-4 sm:grid-cols-2 md:gap-y-12 md:px-0">
                        {[
                            ...
                            <li key={item.title} className="flex max-w-sm flex-col items-start">
                                <item.icon className="size-6 text-icon-fg-brand_on-brand" />

                                <h3 className="mt-3 text-lg font-semibold text-primary_on-brand md:mt-4">{item.title}</h3>
                                <p className="mt-1 text-md text-tertiary_on-brand">{item.subtitle}</p>
                                <Button size="lg" color="link-gray" href={item.href} className="mt-3 whitespace-pre text-primary_on-brand md:mt-4">
                                    {item.cta}
                                </Button>
                            </li>
                        ))}
                    ...
                    <Form
                        ...
                        className="flex flex-col gap-8 bg-primary px-4 py-8 md:rounded-2xl md:px-8 md:py-10"
                    >
