...
const reviews = [
    {
        ...
        rating: 5,
        image: "https://www.untitledui.com/images/portraits/fleur-cook",
    },
    {
                    ...
                    <div className="relative h-170 w-full overflow-hidden lg:order-first lg:h-180">
                        ...
                        <div className="relative">
                            ...
                            <AnimatePresence initial={false} mode="popLayout">
                                ...
                                >
                                    <q className="text-xl font-semibold text-balance text-white md:text-display-sm">{reviews[currentReviewIndex].quote}</q>
                                    ...
                                    <div className="mt-2 flex flex-col justify-between gap-5 md:mt-3 md:flex-row md:gap-3">
                                        <div className="flex flex-col gap-0.5 md:gap-1">
                                            ...
                                            <p className="text-sm font-medium text-white">{reviews[currentReviewIndex].title}</p>
                                        </div>
