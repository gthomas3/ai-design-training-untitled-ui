    ...
    return (
        <footer className="bg-brand-section py-12 md:pt-16">
            <div className="mx-auto max-w-container px-4 md:px-8">
                <div className="flex flex-col justify-between gap-12 md:gap-16 lg:flex-row">
                    ...
                    <nav className="max-w-(--breakpoint-sm) flex-1">
                        <ul className="grid grid-cols-2 gap-8 md:grid-cols-3">
                            {footerNavList.slice(0, 3).map((category) => (
                ...
                <div className="mt-12 flex flex-col gap-y-8 border-t border-brand_alt pt-8 md:mt-16 md:flex-row md:items-end md:justify-between">
                    <div className="max-w-3xl">
                        <p className="text-lg font-semibold text-primary_on-brand md:text-xl">Move faster with Untitled UI</p>
                        <p className="mt-2 text-md text-tertiary_on-brand">Save countless hours of design and ship great looking designs faster.</p>
                    </div>
