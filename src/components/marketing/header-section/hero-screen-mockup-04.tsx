                ...
                <div className="mx-auto grid max-w-container grid-cols-1 items-center justify-items-center gap-16 px-4 md:px-8 lg:grid-cols-2 lg:justify-items-start">
                        ...
                        <div className="mt-16 hidden flex-col gap-6 lg:flex">
                            ...
                            <div className="flex flex-wrap justify-start gap-4">
                                ...
                                <img
                                    ...
                                    className="h-10 object-contain not-dark:hidden"
                                />
                                <img
                                    alt="Kintsugi"
                    ...
                    <div className="relative lg:h-128">
                        ...
                        <img
                            ...
                            className="inset-0 aspect-3/2 h-auto w-full max-w-none rounded object-cover ring-4 ring-screen-mockup-border md:h-90 md:w-auto md:rounded-xl lg:absolute lg:h-full lg:object-left dark:hidden"
                            src="https://www.untitledui.com/marketing/screen-mockups/dashboard-desktop-mockup-light-01.webp"
                        />
                        {/* Dark mode image (hidden in light mode) */}
                        <img
                            alt="Dashboard mockup showing application interface"
                            className="inset-0 aspect-3/2 h-auto w-full max-w-none rounded object-cover ring-4 ring-screen-mockup-border not-dark:hidden md:h-90 md:w-auto md:rounded-xl lg:absolute lg:h-full lg:object-left"
                    ...
                    <div className="flex max-w-3xl flex-col gap-8 lg:hidden">
                        ...
                        <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
                            ...
                            <img
                                alt="Odeaolabs"
                                src="https://www.untitledui.com/logos/logotype/white/odeaolabs.svg"
                                className="h-9 object-contain not-dark:hidden"
                            />
                            <img
                                alt="Kintsugi"
                                src="https://www.untitledui.com/logos/logotype/white/kintsugi.svg"
