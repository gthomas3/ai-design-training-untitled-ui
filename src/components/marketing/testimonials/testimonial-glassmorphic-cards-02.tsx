                            ...
                            <Carousel.Item key={review.author} className="h-96 max-w-72 shrink-0 cursor-grab md:h-120 md:max-w-90">
                                ...
                                <div className="relative">
                                    <div className="absolute inset-x-0 bottom-0 bg-linear-to-t from-black/40 to-black/0 pt-16 md:pt-20 lg:pt-24">
                                        <div className="relative flex cursor-auto flex-col gap-6 bg-alpha-white/30 p-4 pb-5 backdrop-blur-md before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-alpha-white/30 md:p-6">
