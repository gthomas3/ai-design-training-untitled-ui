                ...
                <figure className="flex flex-col gap-10 lg:flex-row lg:gap-32">
                    ...
                    <div className="flex flex-col gap-8 md:pl-8">
                        <div className="flex flex-col gap-4 md:gap-6">
                            ...
                            <blockquote className="text-display-xs font-medium text-balance text-primary_on-brand md:text-display-md">
                                Love the simplicity of the service and the prompt customer support. We can't imagine working without it.
                            </blockquote>
                        </div>
                        <figcaption className="flex flex-col gap-1">
                            <p className="text-lg font-semibold text-primary_on-brand">— Mathilde Lewis</p>
                            <cite className="text-md text-tertiary_on-brand not-italic">Head of Design, Layers</cite>
                        </figcaption>
                    </div>
                </figure>
            </div>
